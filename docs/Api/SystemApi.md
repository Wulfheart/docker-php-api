...
```php
systemAuth($auth_config): \Wulfheart\Docker\Model\SystemAuthResponse
```
...
$apiInstance = new Wulfheart\Docker\Api\SystemApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$auth_config = new \Wulfheart\Docker\Model\AuthConfig(); // \Wulfheart\Docker\Model\AuthConfig | Authentication to check
...
| ------------- | ------------- | ------------- | ------------- |
| **auth_config** | [**\Wulfheart\Docker\Model\AuthConfig**](../Model/AuthConfig.md)| Authentication to check | [optional] |

### Return type

[**\Wulfheart\Docker\Model\SystemAuthResponse**](../Model/SystemAuthResponse.md)
...
```php
systemDataUsage(): \Wulfheart\Docker\Model\SystemDataUsageResponse
```
...
[**\Wulfheart\Docker\Model\SystemDataUsageResponse**](../Model/SystemDataUsageResponse.md)
...
```php
systemEvents($since, $until, $filters): \Wulfheart\Docker\Model\EventMessage
```
...
[**\Wulfheart\Docker\Model\EventMessage**](../Model/EventMessage.md)
...
```php
systemInfo(): \Wulfheart\Docker\Model\SystemInfo
```
...
[**\Wulfheart\Docker\Model\SystemInfo**](../Model/SystemInfo.md)
...
```php
systemVersion(): \Wulfheart\Docker\Model\SystemVersion
```
...
[**\Wulfheart\Docker\Model\SystemVersion**](../Model/SystemVersion.md)
