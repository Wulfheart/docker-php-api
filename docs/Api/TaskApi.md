...
```php
taskInspect($id): \Wulfheart\Docker\Model\Task
```
...
$apiInstance = new Wulfheart\Docker\Api\TaskApi(
...
[**\Wulfheart\Docker\Model\Task**](../Model/Task.md)
...
```php
taskList($filters): \Wulfheart\Docker\Model\Task[]
```
