...
```php
volumeCreate($volume_config): \Wulfheart\Docker\Model\Volume
```
...
$apiInstance = new Wulfheart\Docker\Api\VolumeApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$volume_config = new \Wulfheart\Docker\Model\VolumeCreateOptions(); // \Wulfheart\Docker\Model\VolumeCreateOptions | Volume configuration
...
| ------------- | ------------- | ------------- | ------------- |
| **volume_config** | [**\Wulfheart\Docker\Model\VolumeCreateOptions**](../Model/VolumeCreateOptions.md)| Volume configuration | |

### Return type

[**\Wulfheart\Docker\Model\Volume**](../Model/Volume.md)
...
```php
volumeInspect($name): \Wulfheart\Docker\Model\Volume
```
...
```php
volumeList($filters): \Wulfheart\Docker\Model\VolumeListResponse
```
...
[**\Wulfheart\Docker\Model\VolumeListResponse**](../Model/VolumeListResponse.md)
...
```php
volumePrune($filters): \Wulfheart\Docker\Model\VolumePruneResponse
```
...
[**\Wulfheart\Docker\Model\VolumePruneResponse**](../Model/VolumePruneResponse.md)
