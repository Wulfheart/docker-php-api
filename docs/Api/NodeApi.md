...
$apiInstance = new Wulfheart\Docker\Api\NodeApi(
...
```php
nodeInspect($id): \Wulfheart\Docker\Model\Node
```
...
[**\Wulfheart\Docker\Model\Node**](../Model/Node.md)
...
```php
nodeList($filters): \Wulfheart\Docker\Model\Node[]
```
...
$body = new \Wulfheart\Docker\Model\NodeSpec(); // \Wulfheart\Docker\Model\NodeSpec
...
| **body** | [**\Wulfheart\Docker\Model\NodeSpec**](../Model/NodeSpec.md)|  | [optional] |
