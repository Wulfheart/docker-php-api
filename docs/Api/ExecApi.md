...
```php
containerExec($id, $exec_config): \Wulfheart\Docker\Model\IdResponse
```
...
$apiInstance = new Wulfheart\Docker\Api\ExecApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$id = 'id_example'; // string | ID or name of container
$exec_config = new \Wulfheart\Docker\Model\ExecConfig(); // \Wulfheart\Docker\Model\ExecConfig | Exec configuration
...
| **exec_config** | [**\Wulfheart\Docker\Model\ExecConfig**](../Model/ExecConfig.md)| Exec configuration | |
...
```php
execInspect($id): \Wulfheart\Docker\Model\ExecInspectResponse
```
...
[**\Wulfheart\Docker\Model\ExecInspectResponse**](../Model/ExecInspectResponse.md)
...
$id = 'id_example'; // string | Exec instance ID
$exec_start_config = new \Wulfheart\Docker\Model\ExecStartConfig(); // \Wulfheart\Docker\Model\ExecStartConfig
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **string**| Exec instance ID | |
| **exec_start_config** | [**\Wulfheart\Docker\Model\ExecStartConfig**](../Model/ExecStartConfig.md)|  | [optional] |
