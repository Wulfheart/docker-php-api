...
$apiInstance = new Wulfheart\Docker\Api\SwarmApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$body = new \Wulfheart\Docker\Model\SwarmInitRequest(); // \Wulfheart\Docker\Model\SwarmInitRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\Wulfheart\Docker\Model\SwarmInitRequest**](../Model/SwarmInitRequest.md)|  | |
...
```php
swarmInspect(): \Wulfheart\Docker\Model\Swarm
```
...
[**\Wulfheart\Docker\Model\Swarm**](../Model/Swarm.md)
...
$body = new \Wulfheart\Docker\Model\SwarmJoinRequest(); // \Wulfheart\Docker\Model\SwarmJoinRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\Wulfheart\Docker\Model\SwarmJoinRequest**](../Model/SwarmJoinRequest.md)|  | |
...
$body = new \Wulfheart\Docker\Model\SwarmUnlockRequest(); // \Wulfheart\Docker\Model\SwarmUnlockRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\Wulfheart\Docker\Model\SwarmUnlockRequest**](../Model/SwarmUnlockRequest.md)|  | |
...
```php
swarmUnlockkey(): \Wulfheart\Docker\Model\UnlockKeyResponse
```
...
[**\Wulfheart\Docker\Model\UnlockKeyResponse**](../Model/UnlockKeyResponse.md)
...
$body = new \Wulfheart\Docker\Model\SwarmSpec(); // \Wulfheart\Docker\Model\SwarmSpec
...
| **body** | [**\Wulfheart\Docker\Model\SwarmSpec**](../Model/SwarmSpec.md)|  | |
