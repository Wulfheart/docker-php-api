...
```php
secretCreate($body): \Wulfheart\Docker\Model\IdResponse
```
...
$apiInstance = new Wulfheart\Docker\Api\SecretApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client()
);
$body = new \Wulfheart\Docker\Model\SecretCreateRequest(); // \Wulfheart\Docker\Model\SecretCreateRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **body** | [**\Wulfheart\Docker\Model\SecretCreateRequest**](../Model/SecretCreateRequest.md)|  | [optional] |
...
```php
secretInspect($id): \Wulfheart\Docker\Model\Secret
```
...
[**\Wulfheart\Docker\Model\Secret**](../Model/Secret.md)
...
```php
secretList($filters): \Wulfheart\Docker\Model\Secret[]
```
...
$body = new \Wulfheart\Docker\Model\SecretSpec(); // \Wulfheart\Docker\Model\SecretSpec | The spec of the secret to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [SecretInspect endpoint](#operation/SecretInspect) response values.
...
| **body** | [**\Wulfheart\Docker\Model\SecretSpec**](../Model/SecretSpec.md)| The spec of the secret to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [SecretInspect endpoint](#operation/SecretInspect) response values. | [optional] |
