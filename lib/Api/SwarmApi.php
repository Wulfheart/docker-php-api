...
/**
     ...
     *
     * @param  \Wulfheart\Docker\Model\SwarmInitRequest $body body (required)
     ...
     * @return string|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * Initialize a new swarm
     *
     * @param  \Wulfheart\Docker\Model\SwarmInitRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['swarmInit'] to see the possible values for this operation
     *
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\Swarm|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\Swarm|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function swarmInspectWithHttpInfo(string $contentType = self::contentTypes['swarmInspect'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\Swarm' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\Swarm' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\Swarm', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Wulfheart\Docker\Model\Swarm';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  \Wulfheart\Docker\Model\SwarmJoinRequest $body body (required)
     ...
     * Join an existing swarm
     *
     * @param  \Wulfheart\Docker\Model\SwarmJoinRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['swarmJoin'] to see the possible values for this operation
     *
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Wulfheart\Docker\Model\SwarmUnlockRequest $body body (required)
     ...
     * Unlock a locked manager
     *
     * @param  \Wulfheart\Docker\Model\SwarmUnlockRequest $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['swarmUnlock'] to see the possible values for this operation
     *
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\UnlockKeyResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\UnlockKeyResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function swarmUnlockkeyWithHttpInfo(string $contentType = self::contentTypes['swarmUnlockkey'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\UnlockKeyResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\UnlockKeyResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\UnlockKeyResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\Wulfheart\Docker\Model\UnlockKeyResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\UnlockKeyResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Wulfheart\Docker\Model\SwarmSpec $body body (required)
     ...
     *
     * @param  int $version The version number of the swarm object being updated. This is required to avoid conflicting writes. (required)
     * @param  \Wulfheart\Docker\Model\SwarmSpec $body (required)
     * @param  bool $rotate_worker_token Rotate the worker join token. (optional, default to false)
     * @param  bool $rotate_manager_token Rotate the manager join token. (optional, default to false)
     * @param  bool $rotate_manager_unlock_key Rotate the manager unlock key. (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['swarmUpdate'] to see the possible values for this operation
