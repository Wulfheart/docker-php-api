...
/**
     ...
     * @return \Wulfheart\Docker\Model\PluginPrivilege[]|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\PluginPrivilege[]|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPluginPrivilegesWithHttpInfo($remote, string $contentType = self::contentTypes['getPluginPrivileges'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\PluginPrivilege[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\PluginPrivilege[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\PluginPrivilege[]', []),
            ...
            $returnType = '\Wulfheart\Docker\Model\PluginPrivilege[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\PluginPrivilege[]',
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\Plugin|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\Plugin|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function pluginDeleteWithHttpInfo($name, $force = false, string $contentType = self::contentTypes['pluginDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\Plugin' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\Plugin' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\Plugin', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Wulfheart\Docker\Model\Plugin';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return void
     */
    public function pluginDisable($name, string $contentType = self::contentTypes['pluginDisable'][0])
    {
        $this->pluginDisableWithHttpInfo($name, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function pluginDisableWithHttpInfo($name, string $contentType = self::contentTypes['pluginDisable'][0])
    {
        $request = $this->pluginDisableRequest($name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginDisableAsync($name, string $contentType = self::contentTypes['pluginDisable'][0])
    {
        return $this->pluginDisableAsyncWithHttpInfo($name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function pluginDisableAsyncWithHttpInfo($name, string $contentType = self::contentTypes['pluginDisable'][0])
    {
        $returnType = '';
        $request = $this->pluginDisableRequest($name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function pluginDisableRequest($name, string $contentType = self::contentTypes['pluginDisable'][0])
    {
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\Plugin[]|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\Plugin[]|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \Wulfheart\Docker\Model\PluginPrivilege[] $body body (optional)
     ...
     * @param  string $name Local name for the pulled plugin.  The &#x60;:latest&#x60; tag is optional, and is used as the default if omitted. (optional)
     * @param  string $x_registry_auth A base64url-encoded auth configuration to use when pulling a plugin from a registry.  Refer to the [authentication section](#section/Authentication) for details. (optional)
     * @param  \Wulfheart\Docker\Model\PluginPrivilege[] $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['pluginPull'] to see the possible values for this operation
     *
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
