...
/**
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\Node|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\Node|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function nodeInspectWithHttpInfo($id, string $contentType = self::contentTypes['nodeInspect'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\Node' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\Node' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\Node', []),
            ...
            $returnType = '\Wulfheart\Docker\Model\Node';
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\Node[]|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\Node[]|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \Wulfheart\Docker\Model\NodeSpec $body body (optional)
     ...
     * @param  string $id The ID of the node (required)
     * @param  int $version The version number of the node object being updated. This is required to avoid conflicting writes. (required)
     * @param  \Wulfheart\Docker\Model\NodeSpec $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['nodeUpdate'] to see the possible values for this operation
     *
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
