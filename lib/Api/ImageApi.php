...
/**
     ...
     * @return \Wulfheart\Docker\Model\BuildPruneResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\BuildPruneResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function buildPruneWithHttpInfo($keep_storage = null, $all = null, $filters = null, string $contentType = self::contentTypes['buildPrune'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\BuildPruneResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\BuildPruneResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\BuildPruneResponse', []),
            ...
            $returnType = '\Wulfheart\Docker\Model\BuildPruneResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\BuildPruneResponse',
     ...
     * @param  \Wulfheart\Docker\Model\ContainerConfig $container_config The container configuration (optional)
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\IdResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\IdResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageCommitWithHttpInfo($container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = true, $changes = null, $container_config = null, string $contentType = self::contentTypes['imageCommit'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Wulfheart\Docker\Model\IdResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\IdResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\IdResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Wulfheart\Docker\Model\IdResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\IdResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\ImageDeleteResponseItem[]|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\ImageDeleteResponseItem[]|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageDeleteWithHttpInfo($name, $force = false, $noprune = false, string $contentType = self::contentTypes['imageDelete'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\ImageDeleteResponseItem[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\ImageDeleteResponseItem[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\ImageDeleteResponseItem[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Wulfheart\Docker\Model\ImageDeleteResponseItem[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\ImageDeleteResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SplFileObject|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SplFileObject|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\HistoryResponseItem[]|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\HistoryResponseItem[]|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageHistoryWithHttpInfo($name, string $contentType = self::contentTypes['imageHistory'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\HistoryResponseItem[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\HistoryResponseItem[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\HistoryResponseItem[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Wulfheart\Docker\Model\HistoryResponseItem[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\HistoryResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\ImageInspect|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\ImageInspect|\Wulfheart\Docker\Model\ErrorResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageInspectWithHttpInfo($name, string $contentType = self::contentTypes['imageInspect'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\ImageInspect' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\ImageInspect' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\ImageInspect', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\Wulfheart\Docker\Model\ImageInspect';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\ImageInspect',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\ImageSummary[]|\Wulfheart\Docker\Model\ErrorResponse
     */
    public function imageList($all = false, $filters = null, $digests = false, string $contentType = self::contentTypes['imageList'][0])
    {
        list($response) = $this->imageListWithHttpInfo($all, $filters, $digests, $contentType);
        return $response;
    }
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\ImageSummary[]|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageListWithHttpInfo($all = false, $filters = null, $digests = false, string $contentType = self::contentTypes['imageList'][0])
    {
        $request = $this->imageListRequest($all, $filters, $digests, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\ImageSummary[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\ImageSummary[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\ImageSummary[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\Wulfheart\Docker\Model\ImageSummary[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\ImageSummary[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageListAsync($all = false, $filters = null, $digests = false, string $contentType = self::contentTypes['imageList'][0])
    {
        return $this->imageListAsyncWithHttpInfo($all, $filters, $digests, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageListAsyncWithHttpInfo($all = false, $filters = null, $digests = false, string $contentType = self::contentTypes['imageList'][0])
    {
        $returnType = '\Wulfheart\Docker\Model\ImageSummary[]';
        $request = $this->imageListRequest($all, $filters, $digests, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageListRequest($all = false, $filters = null, $digests = false, string $contentType = self::contentTypes['imageList'][0])
    {
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\ImagePruneResponse|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\ImagePruneResponse|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imagePruneWithHttpInfo($filters = null, string $contentType = self::contentTypes['imagePrune'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\ImagePruneResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\ImagePruneResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\ImagePruneResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\Wulfheart\Docker\Model\ImagePruneResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\ImagePruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Wulfheart\Docker\Model\ImageSearchResponseItem[]|\Wulfheart\Docker\Model\ErrorResponse
     */
     ...
     * @throws \Wulfheart\Docker\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Wulfheart\Docker\Model\ImageSearchResponseItem[]|\Wulfheart\Docker\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageSearchWithHttpInfo($term, $limit = null, $filters = null, string $contentType = self::contentTypes['imageSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Wulfheart\Docker\Model\ImageSearchResponseItem[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Wulfheart\Docker\Model\ImageSearchResponseItem[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Wulfheart\Docker\Model\ImageSearchResponseItem[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\Wulfheart\Docker\Model\ImageSearchResponseItem[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Wulfheart\Docker\Model\ImageSearchResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
