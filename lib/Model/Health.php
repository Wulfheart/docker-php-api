...
class Health implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'failing_streak' => 'int',
        'log' => '\Wulfheart\Docker\Model\HealthcheckResult[]'
    ];
    ...
    */
     ...
     * Gets log
     *
     * @return \Wulfheart\Docker\Model\HealthcheckResult[]|null
     */
     ...
     * Sets log
     *
     * @param \Wulfheart\Docker\Model\HealthcheckResult[]|null $log Log contains the last few results (oldest first)
     *
     * @return self
     */
