...
class EndpointSpec implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets ports
     *
     * @param \Wulfheart\Docker\Model\EndpointPortConfig[]|null $ports List of exposed ports that this service is accessible on from the outside. Ports can only be provided if `vip` resolution mode is used.
     *
     * @return self
     */
