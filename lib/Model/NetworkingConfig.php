...
class NetworkingConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'endpoints_config' => 'array<string,\Wulfheart\Docker\Model\EndpointSettings>'
    ];
    ...
    */
     ...
     *
     * @param array<string,\Wulfheart\Docker\Model\EndpointSettings>|null $endpoints_config A mapping of network name to endpoint configuration for that network.
     *
     * @return self
     */
