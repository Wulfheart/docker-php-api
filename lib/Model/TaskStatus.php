...
class TaskStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'timestamp' => 'string',
        'state' => '\Wulfheart\Docker\Model\TaskState',
        'message' => 'string',
        'err' => 'string',
        'container_status' => '\Wulfheart\Docker\Model\TaskStatusContainerStatus'
    ];
    ...
    */
     ...
     * Sets state
     *
     * @param \Wulfheart\Docker\Model\TaskState|null $state state
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\TaskStatusContainerStatus|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\TaskStatusContainerStatus|null $container_status container_status
     *
     * @return self
     */
