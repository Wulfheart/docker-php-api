...
class ImageInspect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'created' => 'string',
        'container' => 'string',
        'container_config' => '\Wulfheart\Docker\Model\ContainerConfig',
        'docker_version' => 'string',
        'author' => 'string',
        'config' => '\Wulfheart\Docker\Model\ContainerConfig',
        'architecture' => 'string',
        'variant' => 'string',
        'os' => 'string',
        'os_version' => 'string',
        'size' => 'int',
        'virtual_size' => 'int',
        'graph_driver' => '\Wulfheart\Docker\Model\GraphDriverData',
        'root_fs' => '\Wulfheart\Docker\Model\ImageInspectRootFS',
        'metadata' => '\Wulfheart\Docker\Model\ImageInspectMetadata'
    ];
    ...
    */
     ...
     * Sets container
     *
     * @param string|null $container The ID of the container that was used to create the image.  Depending on how the image was created, this field may be empty.
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\ContainerConfig|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\ContainerConfig|null $container_config container_config
     *
     * @return self
     */
     ...
     * Sets config
     *
     * @param \Wulfheart\Docker\Model\ContainerConfig|null $config config
     *
     * @return self
     */
     ...
     * Sets virtual_size
     *
     * @param int|null $virtual_size Total size of the image including all layers it is composed of.  In versions of Docker before v1.10, this field was calculated from the image itself and all of its parent images. Docker v1.10 and up store images self-contained, and no longer use a parent-chain, making this field an equivalent of the Size field.  This field is kept for backward compatibility, but may be removed in a future version of the API.
     *
     * @return self
     */
     ...
     * Gets graph_driver
     *
     * @return \Wulfheart\Docker\Model\GraphDriverData|null
     */
     ...
     * Sets graph_driver
     *
     * @param \Wulfheart\Docker\Model\GraphDriverData|null $graph_driver graph_driver
     *
     * @return self
     */
     ...
     * Gets root_fs
     *
     * @return \Wulfheart\Docker\Model\ImageInspectRootFS|null
     */
     ...
     * Sets root_fs
     *
     * @param \Wulfheart\Docker\Model\ImageInspectRootFS|null $root_fs root_fs
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \Wulfheart\Docker\Model\ImageInspectMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \Wulfheart\Docker\Model\ImageInspectMetadata|null $metadata metadata
     *
     * @return self
     */
