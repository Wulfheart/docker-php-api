...
class HostConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'blkio_weight' => 'int',
        'blkio_weight_device' => '\Wulfheart\Docker\Model\ResourcesBlkioWeightDeviceInner[]',
        'blkio_device_read_bps' => '\Wulfheart\Docker\Model\ThrottleDevice[]',
        'blkio_device_write_bps' => '\Wulfheart\Docker\Model\ThrottleDevice[]',
        'blkio_device_read_i_ops' => '\Wulfheart\Docker\Model\ThrottleDevice[]',
        'blkio_device_write_i_ops' => '\Wulfheart\Docker\Model\ThrottleDevice[]',
        'cpu_period' => 'int',
        'cpu_quota' => 'int',
        ...
        'cpuset_cpus' => 'string',
        'cpuset_mems' => 'string',
        'devices' => '\Wulfheart\Docker\Model\DeviceMapping[]',
        'device_cgroup_rules' => 'string[]',
        'device_requests' => '\Wulfheart\Docker\Model\DeviceRequest[]',
        'kernel_memory' => 'int',
        ...
        'init' => 'bool',
        'pids_limit' => 'int',
        'ulimits' => '\Wulfheart\Docker\Model\ResourcesUlimitsInner[]',
        'cpu_count' => 'int',
        'cpu_percent' => 'int',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('kernel_memory', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Wulfheart\Docker\Model\ResourcesBlkioWeightDeviceInner[]|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\ResourcesBlkioWeightDeviceInner[]|null $blkio_weight_device Block IO weight (relative device weight) in the form:  ``` [{\"Path\": \"device_path\", \"Weight\": weight}] ```
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\ThrottleDevice[]|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\ThrottleDevice[]|null $blkio_device_read_bps Limit read rate (bytes per second) from a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```
     *
     * @return self
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\ThrottleDevice[]|null $blkio_device_write_bps Limit write rate (bytes per second) to a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```
     *
     * @return self
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\ThrottleDevice[]|null $blkio_device_read_i_ops Limit read rate (IO per second) from a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```
     *
     * @return self
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\ThrottleDevice[]|null $blkio_device_write_i_ops Limit write rate (IO per second) to a device, in the form:  ``` [{\"Path\": \"device_path\", \"Rate\": rate}] ```
     *
     * @return self
     */
     ...
     * Gets devices
     *
     * @return \Wulfheart\Docker\Model\DeviceMapping[]|null
     */
     ...
     * Sets devices
     *
     * @param \Wulfheart\Docker\Model\DeviceMapping[]|null $devices A list of devices to add to the container.
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\DeviceRequest[]|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\DeviceRequest[]|null $device_requests A list of requests for devices to be sent to device drivers.
     *
     * @return self
     */
    ...
    {
        if (is_null($kernel_memory)) {
            throw new \InvalidArgumentException('non-nullable kernel_memory cannot be null');
        }
     ...
     * Gets ulimits
     *
     * @return \Wulfheart\Docker\Model\ResourcesUlimitsInner[]|null
     */
     ...
     * Sets ulimits
     *
     * @param \Wulfheart\Docker\Model\ResourcesUlimitsInner[]|null $ulimits A list of resource limits to set in the container. For example:  ``` {\"Name\": \"nofile\", \"Soft\": 1024, \"Hard\": 2048} ```
     *
     * @return self
     */
