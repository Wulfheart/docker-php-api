...
class SystemInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'plugins' => '\Wulfheart\Docker\Model\PluginsInfo',
        'memory_limit' => 'bool',
        'swap_limit' => 'bool',
        'kernel_memory' => 'bool',
        ...
        'registry_config' => '\Wulfheart\Docker\Model\RegistryServiceConfig',
        'generic_resources' => '\Wulfheart\Docker\Model\GenericResourcesInner[]',
        'http_proxy' => 'string',
        'https_proxy' => 'string',
        'no_proxy' => 'string',
        'name' => 'string',
        ...
        'runtimes' => 'array<string,\Wulfheart\Docker\Model\Runtime>',
        'default_runtime' => 'string',
        'swarm' => '\Wulfheart\Docker\Model\SwarmInfo',
        'live_restore_enabled' => 'bool',
        'isolation' => 'string',
        'init_binary' => 'string',
        'containerd_commit' => '\Wulfheart\Docker\Model\Commit',
        'runc_commit' => '\Wulfheart\Docker\Model\Commit',
        'init_commit' => '\Wulfheart\Docker\Model\Commit',
        'security_options' => 'string[]',
        'product_license' => 'string',
        'default_address_pools' => '\Wulfheart\Docker\Model\SystemInfoDefaultAddressPoolsInner[]',
        'warnings' => 'string[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cluster_store', $data ?? [], null);
        $this->setIfExists('cluster_advertise', $data ?? [], null);
    ...
    */
     ...
     * Gets plugins
     *
     * @return \Wulfheart\Docker\Model\PluginsInfo|null
     */
     ...
     * Sets plugins
     *
     * @param \Wulfheart\Docker\Model\PluginsInfo|null $plugins plugins
     *
     * @return self
     */
     ...
     *
     * @param bool|null $kernel_memory_tcp Indicates if the host has kernel memory TCP limit support enabled.  Kernel memory TCP limits are not supported when using cgroups v2, which does not support the corresponding `memory.kmem.tcp.limit_in_bytes` cgroup.
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\RegistryServiceConfig|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\RegistryServiceConfig|null $registry_config registry_config
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\GenericResourcesInner[]|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\GenericResourcesInner[]|null $generic_resources User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`).
     *
     * @return self
     */
    ...
    {
        if (is_null($cluster_store)) {
            throw new \InvalidArgumentException('non-nullable cluster_store cannot be null');
        }
    ...
    {
        if (is_null($cluster_advertise)) {
            throw new \InvalidArgumentException('non-nullable cluster_advertise cannot be null');
        }
     ...
     * Gets runtimes
     *
     * @return array<string,\Wulfheart\Docker\Model\Runtime>|null
     */
     ...
     * Gets swarm
     *
     * @return \Wulfheart\Docker\Model\SwarmInfo|null
     */
     ...
     * Sets swarm
     *
     * @param \Wulfheart\Docker\Model\SwarmInfo|null $swarm swarm
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\Commit|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\Commit|null $containerd_commit containerd_commit
     *
     * @return self
     */
     ...
     * Sets runc_commit
     *
     * @param \Wulfheart\Docker\Model\Commit|null $runc_commit runc_commit
     *
     * @return self
     */
     ...
     * Sets init_commit
     *
     * @param \Wulfheart\Docker\Model\Commit|null $init_commit init_commit
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\SystemInfoDefaultAddressPoolsInner[]|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\SystemInfoDefaultAddressPoolsInner[]|null $default_address_pools List of custom default address pools for local networks, which can be specified in the daemon.json file or dockerd option.  Example: a Base \"10.10.0.0/16\" with Size 24 will define the set of 256 10.10.[0-255].0/24 address pools.
     *
     * @return self
     */
