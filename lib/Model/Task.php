...
class Task implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'version' => '\Wulfheart\Docker\Model\ObjectVersion',
        'created_at' => 'string',
        'updated_at' => 'string',
        'name' => 'string',
        'labels' => 'array<string,string>',
        'spec' => '\Wulfheart\Docker\Model\TaskSpec',
        'service_id' => 'string',
        'slot' => 'int',
        'node_id' => 'string',
        'assigned_generic_resources' => '\Wulfheart\Docker\Model\GenericResourcesInner[]',
        'status' => '\Wulfheart\Docker\Model\TaskStatus',
        'desired_state' => '\Wulfheart\Docker\Model\TaskState',
        'job_iteration' => '\Wulfheart\Docker\Model\ObjectVersion'
    ];
    ...
    */
     ...
     * Gets version
     *
     * @return \Wulfheart\Docker\Model\ObjectVersion|null
     */
     ...
     * Sets version
     *
     * @param \Wulfheart\Docker\Model\ObjectVersion|null $version version
     *
     * @return self
     */
     ...
     * Sets spec
     *
     * @param \Wulfheart\Docker\Model\TaskSpec|null $spec spec
     *
     * @return self
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\GenericResourcesInner[]|null $assigned_generic_resources User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`).
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \Wulfheart\Docker\Model\TaskStatus|null
     */
     ...
     * Sets status
     *
     * @param \Wulfheart\Docker\Model\TaskStatus|null $status status
     *
     * @return self
     */
     ...
     * Gets desired_state
     *
     * @return \Wulfheart\Docker\Model\TaskState|null
     */
     ...
     * Sets desired_state
     *
     * @param \Wulfheart\Docker\Model\TaskState|null $desired_state desired_state
     *
     * @return self
     */
     ...
     * Sets job_iteration
     *
     * @param \Wulfheart\Docker\Model\ObjectVersion|null $job_iteration job_iteration
     *
     * @return self
     */
