...
class NetworkSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'ports' => 'array<string,\Wulfheart\Docker\Model\PortBinding[]>',
        'sandbox_key' => 'string',
        'secondary_ip_addresses' => '\Wulfheart\Docker\Model\Address[]',
        'secondary_ipv6_addresses' => '\Wulfheart\Docker\Model\Address[]',
        'endpoint_id' => 'string',
        'gateway' => 'string',
        ...
        'ipv6_gateway' => 'string',
        'mac_address' => 'string',
        'networks' => 'array<string,\Wulfheart\Docker\Model\EndpointSettings>'
    ];
    ...
    */
     ...
     * Sets bridge
     *
     * @param string|null $bridge Name of the network's bridge (for example, `docker0`).
     *
     * @return self
     */
     ...
     *
     * @return \Wulfheart\Docker\Model\Address[]|null
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\Address[]|null $secondary_ip_addresses 
     *
     * @return self
     */
     ...
     *
     * @param \Wulfheart\Docker\Model\Address[]|null $secondary_ipv6_addresses 
     *
     * @return self
     */
     ...
     * Gets networks
     *
     * @return array<string,\Wulfheart\Docker\Model\EndpointSettings>|null
     */
     ...
     * Sets networks
     *
     * @param array<string,\Wulfheart\Docker\Model\EndpointSettings>|null $networks Information about all networks that the container is connected to.
     *
     * @return self
     */
