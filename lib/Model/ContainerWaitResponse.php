...
class ContainerWaitResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'int',
        'error' => '\Wulfheart\Docker\Model\ContainerWaitExitError'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \Wulfheart\Docker\Model\ContainerWaitExitError|null
     */
     ...
     * Sets error
     *
     * @param \Wulfheart\Docker\Model\ContainerWaitExitError|null $error error
     *
     * @return self
     */
